...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 grid md:grid-cols-2 gap-8 md:gap-12 items-center px-4 md:px-0">
        {/* Left: Text Content */}
        <div className="flex flex-col gap-4 md:gap-6 text-white z-20 text-center md:text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full w-fit backdrop-blur-md animate-fade-down">
            ...
            <span className="text-xs md:text-sm font-medium tracking-wider text-cyan-200 uppercase">ZORIX - Next-Gen Solutions</span>
          </div>
          
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold font-display leading-[1.1] md:leading-[1.1] animate-fade-up">
          ...
          <p className="text-sm md:text-lg lg:text-xl text-slate-300 max-w-lg mx-auto md:mx-0 leading-relaxed animate-fade-up" style={{ animationDelay: '200ms' }}>
          ...
          <div className="flex items-center justify-center md:justify-start gap-3 md:gap-4 mt-4 md:mt-6 animate-fade-up" style={{ animationDelay: '400ms' }}>
            <a 
              href="tel:7483147208"
        ...
        <div className="relative w-full aspect-square md:aspect-auto md:min-h-[400px] lg:min-h-[600px] flex items-center justify-center pointer-events-auto group">
          {/* Glowing Halo - Reduce on mobile */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70%] h-[70%] md:w-[90%] md:h-[90%] bg-cyan-500/5 md:bg-cyan-500/10 rounded-full blur-[60px] md:blur-[100px] animate-pulse-glow-soft transition-all duration-700 group-hover:bg-cyan-500/10 md:group-hover:bg-cyan-500/20 group-hover:scale-105 md:group-hover:scale-110" />
          
          {/* Astronaut Image */}
          <div className="relative z-10 w-full max-w-[300px] md:max-w-[580px] transition-transform duration-700 group-hover:scale-105 animate-astronaut-float animate-rotation-tilt">
            <img 
